      ...
      <div className="flex">
        ...
        {filteredMusicList.length === 0 ? (
          ...
          <img
            ...
            src="https://thumbs.dreamstime.com/b/no-found-symbol-unsuccessful-search-suitable-results-oops-page-failure-concept-flat-outline-vector-illustration-loupe-122872462.jpg"
          />
        ) : (
          <div className="flex justify-evenly flex-wrap ">
            {filteredMusicList &&
              filteredMusicList.map((data, index) => {
                return (
                  <Link key={index} to={`/songs/${data._id}`}>
                    <SongCard key={index} list={data} />
                  </Link>
                );
              })}
          </div>
